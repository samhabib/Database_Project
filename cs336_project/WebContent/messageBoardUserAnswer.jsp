...
<br>
<a href = "messageBoardUser.jsp">Show All Questions</a>
</br>
	...
	try {
		...
		ResultSet rs = stmt.executeQuery("SELECT Question_Board.QuestionID, Question_Board.QuestionTitle, Question_Board.Question, Question_Board.Answer FROM Question_Board WHERE Question_Board.Answer IS NOT NULL;");
